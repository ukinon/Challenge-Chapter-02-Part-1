...
function sortCarByYearDescendingly(cars) {
  ...
  // Apa itu side effect?
  const result = [...cars];
  const sortedResult = bubbleSortDescending(cars);

  console.log(sortedResult);
  return sortedResult;
} 

//Please Uncomment the codes below when testing using node because I get an error in test suite when those lines are uncommented:(
...
// sortCarByYearDescendingly(carsArray);

// const testSort = bubbleSortDescending(carsArray);
